...
void CPUSimulator::startCPU() {
    ...
    while (cpuRunning) {
        ...
        if (drainPipelineMode) {
            ...
            std::cout <<
                    "CYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEENDCYCLEEND"
                    << std::endl;
        }
    }
}
